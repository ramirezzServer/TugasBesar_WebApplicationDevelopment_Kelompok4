        ...
        <div class="js-header">
            ...
            <div class="js-action-group">
                <form action="{{ route('admin.jadwal-sopir') }}" method="GET" class="js-search-form">
                    <input type="text" name="search" class="js-search-input"
                        placeholder="Cari sopir / plat kendaraan / rute / status" value="{{ request('search') }}">
                ...
                <tbody>
                    @forelse($data as $item)
                        <tr>
                            ...
                            <td>{{ $item->jam_selesai ? \Carbon\Carbon::parse($item->jam_selesai)->format('H:i') : '-' }}
                            </td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.jadwal-sopir.destroy', $item->id) }}" method="POST"
                                    style="display:inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="js-btn-danger"
